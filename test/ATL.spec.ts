...
describe('ATL', () => {
  describe('Grammars.Custom parses ATL Expressions', function() {
    ...
    testParseToken(
      parser,
      'teta( a , b, "text", |2016-10-01|, null, false, "agus$interpolation", "string", "str\\$ing")',
      'Expression'
    );
    testParseToken(parser, 'teta(a(b()))', 'Expression');
    testParseToken(parser, 'teta(a(b()))', 'FunctionCall');
    ...
    testParseToken(
      parser,
      'teta("hola $(false) $dia $(a(a))", a , b, "t$ext", |2016-10-01|, null, false, "agus$interpolation", "string", "str$ing")'
    );
  });
});
